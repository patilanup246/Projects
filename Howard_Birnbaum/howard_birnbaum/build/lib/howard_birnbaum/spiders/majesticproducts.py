...
class majesticproducts(scrapy.Spider):
    name="majesticproducts"
    all_urls = []
    scraped_country = ''
    ...
    def start_requests(self):
        for url in self.all_urls:
            url1 = url.split('$')
            req_url = "http://www.heatnglo.com/api/LocatorAjax/LocatorStandardSearch"
            headers = {
                'content-type': "application/json",
            ...
            payload = {
                ...
                "webapisession": {
                    ...
                    "sitecode": "MAJ",
                    "site": "MajesticProducts",
                    "sitebrandname": "Majestic Products",
                    "siterootpath": "/sitecore/content/majesticproducts home/",
                    "environment": "Production",
                    "sessionid": "mt02chb4nfhzlzn3bpwayq0z",
                    "viewedcoupon": "false",
