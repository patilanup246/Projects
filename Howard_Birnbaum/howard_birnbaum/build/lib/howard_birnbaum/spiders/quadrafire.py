...
class quadrafire(scrapy.Spider):
    name="quadrafire"
    all_urls = []
    scraped_country = ''
    ...
    def start_requests(self):
        for url in self.all_urls:
            url1 = url.split('$')
            req_url = "http://www.quadrafire.com/api/LocatorAjax/LocatorStandardSearch"
            headers = {
                'content-type': "application/json",
            ...
            payload = {
                ...
                "webapisession": {
                    ...
                    "sitecode": "QDF",
                    "site": "Quadrafire",
                    "sitebrandname": "Quadra-Fire",
                    "siterootpath": "/sitecore/content/quadrafire home/",
                    "environment": "Production",
                    "sessionid": "d5ijhch4fbdzv1frpdtq5s0s",
                    "viewedcoupon": "true",
