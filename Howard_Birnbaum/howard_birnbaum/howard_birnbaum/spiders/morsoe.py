...
class morsoe(scrapy.Spider):
    ...
    def start_requests(self):
        for url in self.all_urls:
            url1 = url.split('$')
            req_url = "https://morsoe.com/us/?option=com_storelocator&view=map&format=raw&searchall=0&lat={}&lng={}&radius=25&catid=-1&tagid=-1&featstate=0&name_search=".format(str(url1[1]),str(url1[2]))
