...
class europeanhome(scrapy.Spider):
    name="europeanhome"
    all_urls = []
    scraped_country = ''
    ...
    def start_requests(self):
        ...
        req_url = "https://www.europeanhome.com/wp-admin/admin-ajax.php"
        headers = {
            'content-type': "application/x-www-form-urlencoded",
            'cache-control': "no-cache"
        }
        payload = "lat=43.716572&lng=-122.474219&radius=99999&action=csl_ajax_onload"
