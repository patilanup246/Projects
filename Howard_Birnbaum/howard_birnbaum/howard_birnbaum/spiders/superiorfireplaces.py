...
class superiorfireplaces(scrapy.Spider):
    name="superiorfireplaces"
    all_urls = []
    scraped_country = ''
    ...
    def start_requests(self):
        headers = {
            ...
            'host': "superiorfireplaces.us.com",
            'pragma': "no-cache",
            'referer': "http://superiorfireplaces.us.com/dealers",
            'upgrade-insecure-requests': "1",
            'user-agent': "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/64.0.3282.186 Safari/537.36"
            }
        for url in self.all_urls:
            url1 = url.split('$')
            req_url = "http://superiorfireplaces.us.com/dealers?utf8=%E2%9C%93&zip={}&submitted=Search&radius=500".format(str(url1[0]))
    ...
    def parse(self, response):
        ...
        for m in pq('.dealer'):
            ...
            try:
                ...
                print (e)        
            try:
                item['phone_number'] = pq(m)('.phone').text().replace('Phone: ','')
            except Exception as e:
                print (e)        
            try:
                item['web_site_url'] = ''
