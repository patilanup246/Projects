...
class jobstreet(scrapy.Spider):
    ...
    def __init__(self, country = '', *args,**kwargs):
        ...
        while True:
            ...
            a = []
            for i in pq_r('.position-title-link'):
                if not 'https://www.jobstreet.com.sg/en/job/1' == i.attrib['href']:
                    a.append(i.attrib['href'])
                
            self.all_urls = self.all_urls + list(set(a))
...
#             print (e)
    ...
    def parse(self, response):
        ...
        try:  
            ...
            item['job_level']  =  ''
        try:  
            item['company_raw']  =  str(pq('[id="company_name"] a').text().replace('(Recruitment Firm)', ''))
        except Exception as e:  
            item['company_raw']  =  ''
        try:  
